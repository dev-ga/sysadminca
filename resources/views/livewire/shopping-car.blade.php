            ...
            <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-2">
                ...
                @if ($total_item_car != 0)
                    ...
                    <div class="flex justify-end items-center">
                        <button wire:click='pay_sale' type="button" class="flex justify-center text-white text-end bg-[#fd033f] hover:bg-black/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-extrabold rounded-lg text-sm px-2 py-2.5 items-end dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2 mb-2 w-[8rem]">
