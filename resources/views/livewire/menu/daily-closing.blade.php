        ...
        <div class="flex justify-between mt-auto">
            <div class="grid md:grid-cols-3 md:gap-6 mt-5 w-full p-5">
                ...
                {{-- montos --}}
                    ...
                    <div class="w-full">
                        <label for="store" class="block mb-2 text-sm font-medium text-white dark:text-white">Seleccion de Tienda</label>
                        <select wire:model="store" id="store" class="bg-black border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
